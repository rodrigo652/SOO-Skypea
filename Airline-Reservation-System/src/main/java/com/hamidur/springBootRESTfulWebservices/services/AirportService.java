...
public class AirportService
{
    ...
    public List<Airport> getAirportByCity(String airportCity) {
        if(airportCity == null || airportCity.trim().toLowerCase().isEmpty())
            throw new IllegalArgumentException("Invalid input for airport name.");
        return airportRepository.findAllByAirportCity(airportCity);
    }
}
